 ...
 * ============================================================================
 *
 * This file incorporates work from the LEMON graph library (pairing_heap.h).
 *
...
#ifndef _NT_PAIRING_HEAP_H_
#define _NT_PAIRING_HEAP_H_
 ...
 */
  ...
  class PairingHeap {
     ...
     */
    PairingHeap(ItemIntMap& map, const Compare& comp) : _min(0), _iim(map), _comp(comp), _num_items(0) {}
     ...
     * @pre The heap must be non-empty.
     */
    constexpr const Prio& prio() const noexcept { return _data[_min].prio; }
     ...
     */
    constexpr const Prio& operator[](const Item& item) const noexcept { return _data[_iim[item]].prio; }
     ...
     */
    void pop() noexcept {
      nt::TrivialDynamicArray< int > trees;
    ...
    constexpr void decrease(Item item, const Prio& value) noexcept {
      ...
      if (_data[i].left_child && i != _data[p].child) { p = _data[p].parent; }
