...
#ifndef _NT_CONCEPTS_PATH_H_
#define _NT_CONCEPTS_PATH_H_
  ...
  namespace concepts {
    ...
    class Path {
      ...
      Path& operator=(const CPath& cpath) {
        ::nt::ignore_unused_variable_warning(cpath);
        return *this;
      }
      ...
      struct Constraints {
        void constraints() {
          ...
          ::nt::ignore_unused_variable_warning(l);
          ::nt::ignore_unused_variable_warning(pp);
          ::nt::ignore_unused_variable_warning(e);
          ::nt::ignore_unused_variable_warning(id);
          ::nt::ignore_unused_variable_warning(ii);
          ::nt::ignore_unused_variable_warning(ed);
        }
      };
    };
    ...
    namespace _path_bits {
      ...
      struct PathDumperConstraints<
         _Digraph,
         _Path,
         typename std::enable_if< nt::concepts::RevPathTagIndicator< _Path >, void >::type > {
        void constraints() {
          int l = p.length();
          int e = p.empty();
    ...
    class PathDumper {
      ...
      template < typename _Path >
      struct Constraints {
        void constraints() { function_requires< _path_bits::PathDumperConstraints< Digraph, _Path > >(); }
      };
    };
