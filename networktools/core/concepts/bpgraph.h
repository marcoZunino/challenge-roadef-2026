 ...
 * ============================================================================
 *
 * This file incorporates work from the LEMON graph library (bpgraph.h).
 *
...
#ifndef _NT_CONCEPTS_BPGRAPH_H_
#define _NT_CONCEPTS_BPGRAPH_H_
  ...
  namespace concepts {
    ...
    class BpGraph {
      ...
      class BlueNode: public Node {
         ...
         *
         */
        BlueNode(const BlueNode&) = default;
      ...
      class RedNodeIt: public RedNode {
         ...
         *
         */
        RedNodeIt(const RedNodeIt& n) = default;
        /** %Invalid constructor \& conversion. */
      ...
      class BlueNodeIt: public BlueNode {
         ...
         *
         */
        BlueNodeIt(const BlueNodeIt& n) = default;
        /** %Invalid constructor \& conversion. */
      ...
      class IncEdgeIt: public Edge {
         ...
         *
         */
        IncEdgeIt(const IncEdgeIt& e) = default;
        /** %Invalid constructor \& conversion. */
      ...
      class ArcIt: public Arc {
         ...
         *
         */
        explicit ArcIt(const BpGraph& g) { ::nt::ignore_unused_variable_warning(g); }
      ...
      class OutArcIt: public Arc {
        ...
        OutArcIt(const BpGraph& n, const Node& g) {
          ...
          ::nt::ignore_unused_variable_warning(g);
        }
        /** Sets the iterator to the given arc. */
      ...
      class RedNodeMap: public ReferenceMap< Node, T, T&, const T& > {
        ...
        private:
        /** Copy constructor */
        RedNodeMap(const RedNodeMap& nm) : ReferenceMap< Node, T, T&, const T& >(nm) {}
        /** Assignment operator */
        template < typename CMap >
      ...
      class BlueNodeMap: public ReferenceMap< Node, T, T&, const T& > {
        ...
        private:
        /** Copy constructor */
        BlueNodeMap(const BlueNodeMap& nm) : ReferenceMap< Node, T, T&, const T& >(nm) {}
        /** Assignment operator */
        template < typename CMap >
