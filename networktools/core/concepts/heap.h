 ...
 * ============================================================================
 *
 * This file incorporates work from the LEMON graph library (heap.h).
 *
...
#ifndef _NT_CONCEPTS_HEAP_H_
#define _NT_CONCEPTS_HEAP_H_
    ...
    class Heap {
      ...
      struct Constraints {
        ...
        void constraints() {
          ...
          item = Item();
          prio = Prio();
          ::nt::ignore_unused_variable_warning(item);
          ::nt::ignore_unused_variable_warning(prio);
          ...
          own_item = Item();
          own_prio = Prio();
          ::nt::ignore_unused_variable_warning(own_item);
          ::nt::ignore_unused_variable_warning(own_prio);
          ::nt::ignore_unused_variable_warning(own_state);

          _Heap heap1(map);
          _Heap heap2 = heap1;
          ::nt::ignore_unused_variable_warning(heap1);
          ::nt::ignore_unused_variable_warning(heap2);

          int s = heap.size();
          ::nt::ignore_unused_variable_warning(s);
          bool e = heap.empty();
          ::nt::ignore_unused_variable_warning(e);
