 ...
 * ============================================================================
 *
 * This file incorporates work from the LEMON graph library (graph_components.h).
 *
...
#ifndef _NT_CONCEPTS_GRAPH_COMPONENTS_H_
#define _NT_CONCEPTS_GRAPH_COMPONENTS_H_
 ...
 *
 * @note This class is a template class so that we can use it to
 ...
 */
    ...
    class GraphItem {
       ...
       *
       * @note This operator only has to define some strict ordering of
      ...
      struct Constraints {
        void constraints() {
          ...
          bool b;
          ::nt::ignore_unused_variable_warning(b);
      ...
      struct Constraints {
        ...
        void constraints() {
          ...
          checkConcept< GraphItem< 'e' >, Edge >();
          {
            ...
            ::nt::ignore_unused_variable_warning(d);
          }
        }
    ...
    class IDableDigraphComponent: public BAS {
      ...
      struct Constraints {
        void constraints() {
          ...
          ::nt::ignore_unused_variable_warning(nid);
          eid = digraph.maxArcId();
          ::nt::ignore_unused_variable_warning(eid);
        }
    ...
    class IDableGraphComponent: public IDableDigraphComponent< BAS > {
      ...
      struct Constraints {
        void constraints() {
          ...
          ::nt::ignore_unused_variable_warning(ueid);
        }
    ...
    class IDableBpGraphComponent: public IDableGraphComponent< BAS > {
      ...
      struct Constraints {
        void constraints() {
          ...
          ::nt::ignore_unused_variable_warning(rid);
          ::nt::ignore_unused_variable_warning(bid);
        }
    ...
    class GraphItemIt: public Item {
      ...
      struct Constraints {
        void constraints() {
          ...
          ::nt::ignore_unused_variable_warning(it3);
          ::nt::ignore_unused_variable_warning(it4);
     ...
     *
     * @note Since these iterator classes do not inherit from the same
    ...
    class IterableDigraphComponent: public BAS {
      ...
      struct Constraints {
        void constraints() {
          ...
          {
            checkConcept< GraphItemIt< _Digraph, typename _Digraph::Arc >, typename _Digraph::ArcIt >();
            checkConcept< GraphItemIt< _Digraph, typename _Digraph::Node >, typename _Digraph::NodeIt >();
            checkConcept< GraphIncIt< _Digraph, typename _Digraph::Arc, typename _Digraph::Node, 'i' >,
                          typename _Digraph::InArcIt >();
            checkConcept< GraphIncIt< _Digraph, typename _Digraph::Arc, typename _Digraph::Node, 'o' >,
            ...
            ::nt::ignore_unused_variable_warning(n);
          }
        }
    ...
    class IterableGraphComponent: public IterableDigraphComponent< BAS > {
      ...
      struct Constraints {
        void constraints() {
          ...
          {
            checkConcept< GraphItemIt< _Graph, typename _Graph::Edge >, typename _Graph::EdgeIt >();
            checkConcept< GraphIncIt< _Graph, typename _Graph::Edge, typename _Graph::Node, 'e' >,
    ...
    class IterableBpGraphComponent: public IterableGraphComponent< BAS > {
      ...
      struct Constraints {
        void constraints() {
          ...
          checkConcept< GraphItemIt< _BpGraph, typename _BpGraph::RedNode >, typename _BpGraph::RedNodeIt >();
          checkConcept< GraphItemIt< _BpGraph, typename _BpGraph::BlueNode >, typename _BpGraph::BlueNodeIt >();
        }
    ...
    class AlterableDigraphComponent: public BAS {
      ...
      typedef graphs::AlterationNotifier< AlterableDigraphComponent, Node, false > NodeNotifier;
      /** Arc alteration notifier class. */
      typedef graphs::AlterationNotifier< AlterableDigraphComponent, Arc, false > ArcNotifier;
      ...
      struct Constraints {
        void constraints() {
          checkConcept< Base, _Digraph >();
          typename _Digraph::NodeNotifier& nn = digraph.notifier(typename _Digraph::Node());

          typename _Digraph::ArcNotifier& en = digraph.notifier(typename _Digraph::Arc());

          ::nt::ignore_unused_variable_warning(nn);
          ::nt::ignore_unused_variable_warning(en);
        }
    ...
    class AlterableGraphComponent: public AlterableDigraphComponent< BAS > {
      ...
      typedef graphs::AlterationNotifier< AlterableGraphComponent, Edge, false > EdgeNotifier;
      ...
      struct Constraints {
        void constraints() {
          ...
          typename _Graph::EdgeNotifier& uen = graph.notifier(typename _Graph::Edge());
          ::nt::ignore_unused_variable_warning(uen);
        }
    ...
    class AlterableBpGraphComponent: public AlterableGraphComponent< BAS > {
      ...
      typedef graphs::AlterationNotifier< AlterableBpGraphComponent, RedNode, false > RedNodeNotifier;

      /** Blue node alteration notifier class. */
      typedef graphs::AlterationNotifier< AlterableBpGraphComponent, BlueNode, false > BlueNodeNotifier;
      ...
      struct Constraints {
        void constraints() {
          ...
          typename _BpGraph::RedNodeNotifier&  rnn = bpgraph.notifier(typename _BpGraph::RedNode());
          typename _BpGraph::BlueNodeNotifier& bnn = bpgraph.notifier(typename _BpGraph::BlueNode());
          ::nt::ignore_unused_variable_warning(rnn);
          ::nt::ignore_unused_variable_warning(bnn);
        }
    ...
    class GraphMap: public ReferenceMap< K, V, V&, const V& > {
      ...
      struct Constraints {
        void constraints() {
          ...
          ::nt::ignore_unused_variable_warning(m1);
          ::nt::ignore_unused_variable_warning(m2);
          // ::nt::ignore_unused_variable_warning(m3);
        }
    ...
    class MappableDigraphComponent: public BAS {
      ...
      class NodeMap: public GraphMap< MappableDigraphComponent, Node, V > {
         ...
         */
        explicit NodeMap(const MappableDigraphComponent& digraph) : Parent(digraph) {}
         ...
         */
        NodeMap(const MappableDigraphComponent& digraph, const V& value) : Parent(digraph, value) {}
      ...
      class ArcMap: public GraphMap< MappableDigraphComponent, Arc, V > {
         ...
         * Construct a new map for the digraph.
         */
        explicit ArcMap(const MappableDigraphComponent& digraph) : Parent(digraph) {}
         ...
         * Construct a new map for the digraph and initalize the values.
         */
        ArcMap(const MappableDigraphComponent& digraph, const V& value) : Parent(digraph, value) {}
      ...
      struct Constraints {
        ...
        void constraints() {
          ...
          {   // int map test
            ...
            checkConcept< GraphMap< _Digraph, typename _Digraph::Node, int >, IntNodeMap >();
          }
          {   // bool map test
            typedef typename _Digraph::template NodeMap< bool > BoolNodeMap;
            checkConcept< GraphMap< _Digraph, typename _Digraph::Node, bool >, BoolNodeMap >();
          }
          {   // Dummy map test
            typedef typename _Digraph::template NodeMap< Dummy > DummyNodeMap;
            checkConcept< GraphMap< _Digraph, typename _Digraph::Node, Dummy >, DummyNodeMap >();
          }

          {   // int map test
            typedef typename _Digraph::template ArcMap< int > IntArcMap;
            checkConcept< GraphMap< _Digraph, typename _Digraph::Arc, int >, IntArcMap >();
          }
          {   // bool map test
            typedef typename _Digraph::template ArcMap< bool > BoolArcMap;
            checkConcept< GraphMap< _Digraph, typename _Digraph::Arc, bool >, BoolArcMap >();
          }
          {   // Dummy map test
            typedef typename _Digraph::template ArcMap< Dummy > DummyArcMap;
            checkConcept< GraphMap< _Digraph, typename _Digraph::Arc, Dummy >, DummyArcMap >();
          }
        }
    ...
    class MappableGraphComponent: public MappableDigraphComponent< BAS > {
      ...
      class EdgeMap: public GraphMap< MappableGraphComponent, Edge, V > {
         ...
         * Construct a new map for the graph and initalize the values.
         */
        EdgeMap(const MappableGraphComponent& graph, const V& value) : Parent(graph, value) {}
      ...
      struct Constraints {
        ...
        void constraints() {
          ...
          {   // Dummy map test
            ...
            checkConcept< GraphMap< _Graph, typename _Graph::Edge, Dummy >, DummyEdgeMap >();
          }
        }
    ...
    class MappableBpGraphComponent: public MappableGraphComponent< BAS > {
      ...
      class RedNodeMap: public GraphMap< MappableBpGraphComponent, Node, V > {
         ...
         * Construct a new map for the graph.
         */
        explicit RedNodeMap(const MappableBpGraphComponent& graph) : Parent(graph) {}
         ...
         * Construct a new map for the graph and initalize the values.
         */
        RedNodeMap(const MappableBpGraphComponent& graph, const V& value) : Parent(graph, value) {}
      ...
      class BlueNodeMap: public GraphMap< MappableBpGraphComponent, Node, V > {
         ...
         * Construct a new map for the graph.
         */
        explicit BlueNodeMap(const MappableBpGraphComponent& graph) : Parent(graph) {}
         ...
         * Construct a new map for the graph and initalize the values.
         */
        BlueNodeMap(const MappableBpGraphComponent& graph, const V& value) : Parent(graph, value) {}
      ...
      struct Constraints {
        ...
        void constraints() {
          ...
          {   // int map test
            ...
            checkConcept< GraphMap< _BpGraph, typename _BpGraph::RedNode, int >, IntRedNodeMap >();
          }
          {   // bool map test
            typedef typename _BpGraph::template RedNodeMap< bool > BoolRedNodeMap;
            checkConcept< GraphMap< _BpGraph, typename _BpGraph::RedNode, bool >, BoolRedNodeMap >();
          }
          {   // Dummy map test
            typedef typename _BpGraph::template RedNodeMap< Dummy > DummyRedNodeMap;
            checkConcept< GraphMap< _BpGraph, typename _BpGraph::RedNode, Dummy >, DummyRedNodeMap >();
          }

          {   // int map test
            typedef typename _BpGraph::template BlueNodeMap< int > IntBlueNodeMap;
            checkConcept< GraphMap< _BpGraph, typename _BpGraph::BlueNode, int >, IntBlueNodeMap >();
          }
          {   // bool map test
            typedef typename _BpGraph::template BlueNodeMap< bool > BoolBlueNodeMap;
            checkConcept< GraphMap< _BpGraph, typename _BpGraph::BlueNode, bool >, BoolBlueNodeMap >();
          }
          {   // Dummy map test
            typedef typename _BpGraph::template BlueNodeMap< Dummy > DummyBlueNodeMap;
            checkConcept< GraphMap< _BpGraph, typename _BpGraph::BlueNode, Dummy >, DummyBlueNodeMap >();
          }
        }
