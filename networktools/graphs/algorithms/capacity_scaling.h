 ...
 * ============================================================================
 *
 * This file incorporates work from the LEMON graph library (capacity_scaling.h).
 *
...
#ifndef _NT_CAPACITY_SCALING_H_
#define _NT_CAPACITY_SCALING_H_
...
namespace nt {
  namespace graphs {
    ...
    struct CapacityScalingDefaultTraits {
       ...
       */
      using Heap = BinHeap< Cost, RangeMap< int > >;
    };
...
#else
    template < typename GR, typename V = int, typename C = V, typename TR = CapacityScalingDefaultTraits< GR, V, C > >
#endif
    class CapacityScaling {
      ...
      class ResidualDijkstra {
        ...
        ResidualDijkstra(CapacityScaling& cs) :
            _node_num(cs._node_num), _geq(cs._sum_supply < 0), _first_out(cs._first_out), _target(cs._target),
            _cost(cs._cost), _res_cap(cs._res_cap), _excess(cs._excess), _pi(cs._pi), _pred(cs._pred),
            _dist(cs._node_num) {}
      ...
      struct SetHeap: public CapacityScaling< GR, V, C, SetHeapTraits< T > > {
        using Create = CapacityScaling< GR, V, C, SetHeapTraits< T > >;
      };
      ...
      CapacityScaling(const GR& graph) :
        ...
        NT_ASSERT(std::numeric_limits< Value >::is_signed, "The flow type of CapacityScaling must be signed");
        NT_ASSERT(std::numeric_limits< Cost >::is_signed, "The cost type of CapacityScaling must be signed");
      ...
      ProblemType startWithoutScaling() {
        ...
        int              s, t;
        ResidualDijkstra _dijkstra(*this);
        while (_excess[_excess_nodes[next_node]] > 0 || ++next_node < int(_excess_nodes.size())) {
          // Run Dijkstra in the residual network
          s = _excess_nodes[next_node];
